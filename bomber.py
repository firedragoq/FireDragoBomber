...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("FireDragoBomber is up-to-date")
        mesgdcrt.GeneralMessage("Starting FireDragoBomber")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("FireDragoBomber was created by FireDragoq")
    mesgdcrt.SuccessMessage("FireDragoBomber was modified by FireDragoq")
...
description = """FireDragoBomber - Your Friendly Spammer Application

FireDragoBomber can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

FireDragoBomber is not intented for malicious uses.
"""
